        ...
        <TabsContent value="ventas" className="space-y-6">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">${reporteVentas?.resumen?.monto_total?.toLocaleString() || 0}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{reporteVentas?.resumen?.crecimiento_monto?.toFixed(1) || 0}%</div>
